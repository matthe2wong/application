 ...
 * @version 1.0
 */
class Wx_Appointment1Controller extends Zend_Controller_Action
{
    /**
     * 成员变量
     */
...
//         $openid = Application_Model_WxUser::getWeixinOpenid();
        $this->view->num = $this->modelUserInfo->getList(array("openid"=>1));
        $this->view->data = $this->modelUserInfo->getList(array("openid"=>1));
    }
